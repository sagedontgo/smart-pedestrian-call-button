	...
	theme: {
		...
		extend: {
			colors: {
				...
				'traffic-red-glow': 'hsl(var(--traffic-red-glow))',
				'traffic-amber': 'hsl(var(--traffic-amber))',
				'traffic-amber-glow': 'hsl(var(--traffic-amber-glow))',
				'traffic-green': 'hsl(var(--traffic-green))',
				'traffic-green-glow': 'hsl(var(--traffic-green-glow))',
